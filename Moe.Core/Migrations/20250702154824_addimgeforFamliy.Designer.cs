...
namespace Moe.Core.Migrations
{
    ...
    [Migration("20250702154824_addimgeforFamliy")]
    partial class addimgeforFamliy
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Moe.Core.Models.Entities.FamilyDevice", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Moe.Core.Models.Entities.Warehouse", b =>
                {
                    ...
                    b.Property<string>("DonationImage")
                        .HasMaxLength(128)
                        .HasColumnType("character varying(128)");
            ...
            modelBuilder.Entity("Moe.Core.Models.Entities.FamilyDevice", b =>
                {
                    b.HasOne("Moe.Core.Models.Entities.Device", "Device")
                        .WithMany("FamilyDevices")
